...
Depth
You can specify the "depth" of data extracted from Burp's logs, setting the -d option to either 1, 2 or 3.
Depth 1: Just extract domain information.
...
== Usage
	...
	Specific Options:
	    ...
	    -d, -d <depth>                   Depth: 1, 2 or 3. Defaults to 2
